...
#/usr/src/daily_processing_code_elrond/test.pro -a 12 -m1 -t 2.0 -N 8192 $1
/usr/src/daily_processing_code_elrond/daily_processing_code_elrond_new_agc_mod_start -a 12 -m16 -t 2.0 -N 8192 $1
#Make the grayscales
