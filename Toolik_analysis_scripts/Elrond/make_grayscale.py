...
for file in glob.glob(data_dir + '2015*TLK*.data'):
	print file
...
#        print "date parsed!"
		...
		print "unswapping!"
		subprocess.call(['/usr/src/fix_random_swap/fix_random_swap_2.0 -N {0} -a{1} {2}'.format(N,a,file)],shell=True, cwd=data_dir)
